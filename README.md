...
**One ZIP for one GitHub repository.** This bundle contains the paper,
authorship and citation files, licenses, complete reviewed proof packet, and
all fresh computational evidence. Upload the extracted folder contents.
Every file is at most 20 MiB. See [upload instructions](UPLOAD_AND_REPRODUCE.md).
...
raw records are included in fresh-evidence/parts/; see
